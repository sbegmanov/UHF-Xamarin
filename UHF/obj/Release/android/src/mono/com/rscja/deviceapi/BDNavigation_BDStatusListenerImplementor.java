...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onBDSatelliteChanged:(Ljava/util/ArrayList;)V:GetOnBDSatelliteChanged_Ljava_util_ArrayList_Handler:Com.Rscja.Deviceapi.BDNavigation/IBDStatusListenerInvoker, DeviceAPI\n" +
			...
			"";
		mono.android.Runtime.register ("Com.Rscja.Deviceapi.BDNavigation+IBDStatusListenerImplementor, DeviceAPI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", BDNavigation_BDStatusListenerImplementor.class, __md_methods);
	}
	...
	public BDNavigation_BDStatusListenerImplementor ()
	{
		...
		if (getClass () == BDNavigation_BDStatusListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Rscja.Deviceapi.BDNavigation+IBDStatusListenerImplementor, DeviceAPI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
	...
	public void onSpeed (double p0)
	{
		n_onSpeed (p0);
	}

	private native void n_onSpeed (double p0);
